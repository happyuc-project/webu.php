...
class HucabiTest extends TestCase
{
    ...
    /**
     * encodingTests
     * from webu abi.encodeParameter.js test
     * and webu eth.abi.encodeParameters test
     * and webu eth.abi.encodeParameter test
     * 
     * @param array
     */
    ...
    /**
     * decodingTests
     * from webu abi.decodeParameter.js test
     * and webu eth.abi.decodeParameters test
     * and webu eth.abi.decodeParameter test
     * 
     * @param array
     */
